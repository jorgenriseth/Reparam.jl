...
function l2_norm(f; I::AbstractIntegrator)
    return I(f, L2Norm())
end

function l2_distance(f, g; I::AbstractIntegrator)
    return I(f, g, L2Distance())
end

function l2_inner_product(f, g; I::AbstractIntegrator)
    return I(f, g, L2InnerProduct())
end


""" Compute the Palais Metric to be used later."""
function palais_inner_product(f, g; I::AbstractIntegrator)
